...
//自己添加的
static TaskHandle_t DATAhandle;
char th_data[13];
int size_test=0;
...
static const uint8_t char_value_test[]             = "whoisyourdaddy!";
...
static const esp_gatts_attr_db_t gatt_db[HRS_IDX_NB] =
{
    ...
    {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&GATTS_CHAR_UUID_TEST_D, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE,
      GATTS_DEMO_CHAR_VAL_LEN_MAX, sizeof(th_data), (uint8_t *)th_data}},
...
static void gatts_profile_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param)
{
    switch (event) {
        ...
        case ESP_GATTS_CONNECT_EVT:
            ...
            xTaskCreate(DATAread_task,"DATAread_task",1024,NULL,2,&DATAhandle);
...
uint ReadValue()
{   /*
    PROXMSB = LDC_ReadReg(LDC1000_CMD_PROXMSB);

    PROXLSB = LDC_ReadReg(LDC1000_CMD_PROXLSB);
    return PROXLSB;
    */
    uint iTemp;
...
void app_main(void)
{
    ...
    // PIN_NUM_MISO 19
    gpio_configstructure.pin_bit_mask = 1 << PIN_NUM_MISO;
    gpio_configstructure.mode = GPIO_MODE_INPUT;
    ...
    // PIN_NUM_MOSI 23
    gpio_configstructure.pin_bit_mask = 1 << PIN_NUM_MOSI;
    ...
    // PIN_NUM_CLK 18
    gpio_configstructure.pin_bit_mask = 1 << PIN_NUM_CLK;
    gpio_configstructure.mode = GPIO_MODE_OUTPUT;
    gpio_configstructure.pull_up_en = GPIO_PULLUP_DISABLE;
    gpio_configstructure.pull_down_en = GPIO_PULLDOWN_DISABLE;
    gpio_configstructure.intr_type = GPIO_INTR_DISABLE;
